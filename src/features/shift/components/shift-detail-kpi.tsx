...
interface ShiftDetailKpiProps {
  data: ShiftDetail;
}

export function ShiftDetailKpi({ data }: ShiftDetailKpiProps) {
  const totalNetIncome = data.totalIncome - data.totalExpense;
    ...
    <div className="grid grid-cols-4 gap-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardTitle className="text-2xl">{formatToIDR(totalNetIncome)}</CardTitle>
        </CardHeader>
      </Card>
      <Card>
        <CardHeader>
